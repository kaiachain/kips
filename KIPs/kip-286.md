...
Additionally, the total pausable time per epoch is limited to prevent abuse of the `ValPaused` state. It should not distinguish between voluntary and involuntary paused. Validators who exceed the maximum allowed paused time within an epoch will be penalized through VRank violation as defined in KIP-227.
