...
| `PFS_THRESHOLD`          | Threshold for proposal failure score (PFS) per epoch. Exceeding triggers severe violation (defined in [KIP-227](./kip-227.md)) | TBD                                                           |
| `CFS_THRESHOLD`          | Threshold for candidate failure score during VRank testing. Exceeding fails the testing (defined in [KIP-227](./kip-227.md))   | TBD                                                           |
