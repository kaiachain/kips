...
struct bundle {
    ...
    // BundleTxs is placed AFTER the target tx. If the hash is empty, it is placed at the very front.
    TargetTxHash  hash
}
...
Timeout handler must be delayed if a bundle is currently being executed.
