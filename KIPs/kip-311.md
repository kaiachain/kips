...
| Connection class    | `peerNodes` CN authorization  |
| ------------------- | ----------------------------- |
| Trusted peer        | Exempt                        |
| Static outbound     | Exempt                        |
| Static inbound      | Enforced for CN-claimed peers |
| Dynamic inbound     | Enforced for CN-claimed peers |
| Dynamic outbound    | Enforced for CN-claimed peers |
| EN, BN, or PN-as-EN | N/A                           |
...
- EN, BN, and PN-as-EN connections do not require `peerNodes` authorization.
