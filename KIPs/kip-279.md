...
|| `0x01` | The wrapper_version of `BlobTxWithBloV1bs` |
...
- Validators MUST assure that the `BlobTxWithBlobs` is verified *before commiting to the block*. Note that verifying a `BlobTxWithBlobs` does not require block execution.
